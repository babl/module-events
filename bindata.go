...
func subscriptionsYmlBytes() ([]byte, error) {
	return _subscriptionsYml, nil
}

func subscriptionsYml() (*asset, error) {
	bytes, err := subscriptionsYmlBytes()
	if err != nil {
		return nil, err
	}
...
var _bindata = map[string]func() (*asset, error){
	"subscriptions.yml": subscriptionsYml,
}
...
var _bintree = &bintree{nil, map[string]*bintree{
	"subscriptions.yml": &bintree{subscriptionsYml, map[string]*bintree{}},
}}
